...
public enum PremiumScoreLevel {
    ...
    LOW   (0,  17, "전반적 인지 기능 저하 신호","현재 인지 기능에서 특별한 변화 신호는 관찰되지 않았습니다." + "뇌 건강 유지를 위해 다음과 같은 활동을 추천드립니다:" ,List.of("가족이나 익숙한 사람의 이름이 쉽게 떠오르지 않음", "날짜, 시간, 장소 등에 대한 혼동", "반복적인 질문, 같은 말을 여러 번 하는 경향", "일상적인 대화나 의사 표현의 어려움", "감정 조절의 어려움 또는 무기력감 증가")),
    ...
    HIGH  (24, 30, "인지 손상 없음","이 범위에서는 전반적인 인지 처리 능력에서 변화 가능성이 높아, 일상생활에서 다음과 같은 어려움이 나타날 수 있습니다:" ,List.of("규칙적인 운동", "충분한 수면과 일정한 수면 패턴 유지 ", "일상 속 대화와 사회적 교류", "퍼즐 맞추기, 단어 퀴즈, 계산 게임 등 인지 자극 활동", "균형 잡힌 식사와 영양분 섭취"));
