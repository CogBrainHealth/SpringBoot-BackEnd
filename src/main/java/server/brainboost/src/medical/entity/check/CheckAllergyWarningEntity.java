...
import server.brainboost.src.medical.entity.check.enums.AllergyTag;
import server.brainboost.src.medical.entity.nutrient.NutrientEntity;

@Entity
@Getter
@Table(name = "check_allergy_warning")
@NoArgsConstructor
@DynamicInsert
public class CheckAllergyWarningEntity extends BaseEntity {
