...
public class StatisticsService {
    ...
    public MyGameStatisticsDTO getMyGameStatistics(Long userId) {
        ...
        for(UserStatisticsEntity userStatistics : userStatisticsEntityList){
            ...
            if(userStatistics.getGameType().getTypeName().equals("attention")){

                myGameStatisticsDTO.setAttentionScore(score);
                totalScore += score;
            }else if(userStatistics.getGameType().getTypeName().equals("spatial_perception")){

                myGameStatisticsDTO.setSpatialPerceptionScore(score);
                totalScore += score;
            }
            else if(userStatistics.getGameType().getTypeName().equals("memory")){
